...
- Thời gian chạy: 2026-06-10 15:44:15
...
| --- | --- | --- | --- | --- | --- | --- |
| 1.1 | WER - phòng yên tĩnh | < 22% | 32.2% | Không đạt | Cao | jiwer.wer(ref,hyp) sau chuẩn hoá; audio sạch |
| 1.3 | CER - tiếng Việt có dấu | < 13% | 23.6% | Không đạt | Cao | jiwer.cer(ref,hyp) |
...
| ID | Tiêu chí | Ngưỡng | Giá trị đo | Kết quả | Ưu tiên | Cách đo |
| --- | --- | --- | --- | --- | --- | --- |
| 4.1 | WER toàn phiên (nội dung DOCX) | < 27% | 32.2% | Không đạt | Rất cao | So bản ghi tay toàn phiên với text trong DOCX |
...
```json
{
  "wer": 0.3219026548672566,
  "cer": 0.2361323155216285,
