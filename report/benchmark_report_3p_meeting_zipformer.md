...
- Thời gian chạy: 2026-06-11 10:20:22
...
| 4.3 | RTF end-to-end (warm) | < 1.5 | 0.44 | Đạt | Rất cao | Từ bắt đầu xử lý đến xuất DOCX / thời lượng audio |
...
| 5.4 | Thời gian tóm tắt (Qwen NPU) | < 60s / phiên | 61.28s | Không đạt | TB | Đo wall-clock gọi Nexa |
...
```json
{
  ...
  "rtf_stt": 0.024969211822660098,
  "rtf_diarization": 0.15960673234811168,
  "rtf_e2e": 0.43819868637110015,
  "finalize_ratio": 0.0016001642036124794,
  "summary_time": 61.2827,
  "docx_export_time": 0.11,
  "rouge_l": null
}
```
